---
title: 05. Incorporating plain language and technical writing techniques in your work
layout: default
nav_order: 50
has_toc: false
---
...
You can read further breakdowns in the [Five Steps to Plain Language](https://centerforplainlanguage.org/learning-training/five-steps-plain-language/) article (sometimes in excruciating detail, but at least delivered in the form of easy-to-follow bulleted lists) by the Center for Plain Language. Adapting this solution as a form of checklist for technical writing tasks may be a game-changer for those who enter the field of creating documentation.
